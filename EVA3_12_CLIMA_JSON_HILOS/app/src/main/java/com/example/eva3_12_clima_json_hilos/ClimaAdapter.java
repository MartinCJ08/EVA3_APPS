...
public class ClimaAdapter extends ArrayAdapter<Clima> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imgClima = convertView.findViewById(R.id.imgVwClima);
        txtCiudad = convertView.findViewById(R.id.txtVwCiudad);
        txtDesc = convertView.findViewById(R.id.txtVwDesc);
        txtTemp = convertView.findViewById(R.id.txtVwDesc);
        txtClima = convertView.findViewById(R.id.txtVwClima);
        ...
        txtTemp.setText(cClima.getTemperatura()+" °F");
